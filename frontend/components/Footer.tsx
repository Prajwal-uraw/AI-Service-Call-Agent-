        ...
        <div className="grid md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="text-neutral-400 hover:text-white transition-colors" aria-label="View our GitHub">
              ...
              <a href="#" className="text-neutral-400 hover:text-white transition-colors" aria-label="Connect on LinkedIn">
