-- =====================================================
-- STANDALONE MIGRATION - CREATES NEW TENANT TABLES
-- =====================================================
-- This script creates NEW multi-tenant tables for Voice Agent
-- WITHOUT touching your existing CRM tables (contacts, leads, etc.)
-- 
-- Your existing CRM remains internal-only (no tenant_id needed)
-- New Voice Agent tables are multi-tenant from the start
-- =====================================================
...
-- =====================================================
-- TENANTS TABLE (Voice Agent Customers)
-- =====================================================
...
-- =====================================================
-- CALL LOGS TABLE (Voice Agent Calls - Multi-Tenant)
-- =====================================================
...
-- =====================================================
-- APPOINTMENTS TABLE (Voice Agent Appointments)
-- =====================================================
...
BEGIN
    RAISE NOTICE '';
    RAISE NOTICE '==============================================';
    RAISE NOTICE '✅ STANDALONE MIGRATION COMPLETED!';
    RAISE NOTICE '==============================================';
    RAISE NOTICE '✅ Created 9 new multi-tenant tables for Voice Agent';
    RAISE NOTICE '✅ Your existing CRM tables remain untouched';
    RAISE NOTICE '✅ No tenant_id added to existing tables';
    RAISE NOTICE '✅ 5 industry templates added';
    RAISE NOTICE '';
    RAISE NOTICE '📊 New Tables Created:';
    RAISE NOTICE '   - tenants (Voice Agent customers)';
    RAISE NOTICE '   - tenant_users';
    RAISE NOTICE '   - tenant_api_keys';
    RAISE NOTICE '   - call_logs (multi-tenant)';
    RAISE NOTICE '   - appointments (multi-tenant)';
    RAISE NOTICE '   - usage_tracking';
    RAISE NOTICE '   - ai_agent_configs';
    RAISE NOTICE '   - ai_config_templates';
    RAISE NOTICE '   - ai_config_audit_log';
    RAISE NOTICE '';
    RAISE NOTICE '🔒 Your Existing CRM Tables (Preserved):';
    RAISE NOTICE '   - contacts (internal use only)';
    RAISE NOTICE '   - leads (internal use only)';
    RAISE NOTICE '   - tasks (internal use only)';
    RAISE NOTICE '   - notes (internal use only)';
    RAISE NOTICE '==============================================';
END $$;
